<template>
  <section id="dashboard" style="padding-left:50px">
    ...
    <section class="mt-lg-5">
      <mdb-row>
        <mdb-col xl="4" md="4" class="mb-r" v-for="(tt,index) in tinhtrang" :key="index">
          <mdb-card cascade class="cascading-admin-card">
            <div class="admin-up">
                <mdb-icon icon="tree" class="primary-color" />
              <!-- <mdb-icon icon="tree" far /> -->
              <div class="data">
                <p style="font-size:14px; text-transform: uppercase;">SỐ LƯỢNG CÂY {{tt.tinhtrang}}</p>
                <h4>
                  <strong>
                   </strong>
                </h4>
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Số lượng cây {{tt.tinhtrang}}</mdb-card-text>
            </mdb-card-body>
